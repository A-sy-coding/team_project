    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_image', models.ImageField(blank=True, null=True, upload_to='profile_image/', verbose_name='프로필사진')),
                ('user_background', models.ImageField(blank=True, null=True, upload_to='profile_image/', verbose_name='배경사진')),
            ],
            options={
                'verbose_name': '유저',
